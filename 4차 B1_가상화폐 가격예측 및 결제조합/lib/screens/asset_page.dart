          ...
          children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      SizedBox(width: 100),
                      Text(
                        '예상가치 : ${f.format(AssetController.to.assets[code] * AssetController.to.prices[code]).toString()}원',
            ...
            Expanded(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Upbit : ${f.format(marketData['Upbit'])}원'),
                  Text(
                      'Upbit 달러 : ${marketData['Upbit_dollar'].toStringAsFixed(4)}달러'),
                  Text(
